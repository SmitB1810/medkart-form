  ...
  <div class="inline" v-if="shouldDisplayProTag">
    ...
    <modal :show="showPremiumModal" @close="showPremiumModal=false">
      ...
      <h4 v-if="user && user.is_subscribed" class="text-center mt-5">
        We're happy to have you as a Pro customer. If you're having any issue with Medkart, or if you have a
      ...
      <div v-if="!user || !user.is_subscribed" class="mt-4">
        ...
        >
          PRO
        </span> tag are available in the Pro plan of Medkart. <b>You can play around and try all Pro features
          within
