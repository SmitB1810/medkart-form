...
useHead({
  titleTemplate: (titleChunk) => {
    ...
    if (industry.value
      ...
      && !industry.value.meta_title.toLowerCase().includes('medkart')
    ) {
      return titleChunk ? `${titleChunk} - Medkart` : 'Form Templates - Medkart'
    }
    return titleChunk ? titleChunk : 'Form Templates - Medkart'
  }
})
