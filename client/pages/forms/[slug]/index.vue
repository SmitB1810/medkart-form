      ...
      <div v-if="!formLoading && !form">
        ...
        <p class="mb-10 mt-4">
          <router-link :to="{name:'index'}">
            Create your form for free with Medkart
          </router-link>
        </p>
      </div>
...
useOpnSeoMeta({
  ...
  ogImage: () => {
    if (form && form.value.seo_meta.page_thumbnail) {
